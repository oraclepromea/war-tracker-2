# Test with OpenAI using your sk-proj- key

echo "1. Deploy the updated function (now uses OpenAI API):"
...
echo "Should return structured war event data instead of 401 errors"